...
class DirectionSalesReport(models.Model):
    ...
    margin = fields.Float(string='Margin', readonly=True, groups='al_dashboard_twizza.group_twizza_dashboard_manager')
    margin_invoiced = fields.Float(string='Margin Invoiced', readonly=True, groups='al_dashboard_twizza.group_twizza_dashboard_manager')
